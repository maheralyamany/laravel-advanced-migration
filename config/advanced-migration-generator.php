...
return [
    ...
    //default configs
    'table_naming_scheme' => env('LMG_TABLE_NAMING_SCHEME', '[IndexedTimestamp]_[TableName].php'),
    'view_naming_scheme' => env('LMG_VIEW_NAMING_SCHEME', '[IndexedTimestamp]_[ViewName]_view.php'),
    'path' => env('LMG_OUTPUT_PATH', 'database\migrations'),
    'skippable_tables' => env('LMG_SKIPPABLE_TABLES', 'migrations,failed_jobs,personal_access_tokens'),
    'skip_views' => env('LMG_SKIP_VIEWS', true),
    ...
    'definitions' => [
        ...
        'use_defined_foreign_key_index_names' => env('LMG_USE_DEFINED_FOREIGN_KEY_INDEX_NAMES', false),
    ...
    //null = use default
    \AdvancedMigration\Constants::MYSQL_DRIVER => [
   ...
   \AdvancedMigration\Constants::SQLITE_DRIVER => [
    ...
    \AdvancedMigration\Constants::PGSQL_DRIVER => [
    ...
    \AdvancedMigration\Constants::SQLSRV_DRIVER => [
