...
class ViewFormatter
{
    ...
    protected function getStubPath()
    {
        ...
        if (file_exists($overridden = resource_path('stubs/vendor/advanced-migration-generator/' . $driver . '-view.stub'))) {
            return $overridden;
        }

        if (file_exists($overridden = resource_path('stubs/vendor/advanced-migration-generator/view.stub'))) {
            return $overridden;
        }
