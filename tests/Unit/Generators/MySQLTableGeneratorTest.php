...
class MySQLTableGeneratorTest extends TestCase
{
    ...
    {
        Config::set('advanced-migration-generator.table_naming_scheme', '0000_00_00_000000_create_[TableName]_table.php');
        $generator = TableGenerator::init('table', [
            '`id` int(9) unsigned NOT NULL AUTO_INCREMENT PRIMARY KEY',
            '`user_id` int(9) unsigned NOT NULL',
            '`note` varchar(255) NOT NULL',
    ...
    {
        config()->set('advanced-migration-generator.definitions.use_defined_datatype_on_timestamp', true);
        $generator = TableGenerator::init('table', [
            'id int auto_increment primary key',
