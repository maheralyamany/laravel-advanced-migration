...
class IndexTokenizerTest extends TestCase
{
    ...
    {
        config()->set('advanced-migration-generator.definitions.use_defined_index_names', false);
        $indexTokenizer = IndexTokenizer::parse('KEY `password_resets_email_index` (`email`)');
        $indexDefinition = $indexTokenizer->definition();
        ...
        config()->set('advanced-migration-generator.definitions.use_defined_index_names', true);
    }
    ...
    {
        config()->set('advanced-migration-generator.definitions.use_defined_unique_key_index_names', false);
        $indexTokenizer = IndexTokenizer::parse('UNIQUE KEY `users_email_unique` (`email`)');
        $indexDefinition = $indexTokenizer->definition();
        ...
        config()->set('advanced-migration-generator.definitions.use_defined_unique_key_index_names', true);
    }
    ...
    {
        config()->set('advanced-migration-generator.definitions.use_defined_foreign_key_index_names', false);
        $indexTokenizer = IndexTokenizer::parse('CONSTRAINT `fk_bank_accounts_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)');
        $indexDefinition = $indexTokenizer->definition();
        ...
        config()->set('advanced-migration-generator.definitions.use_defined_foreign_key_index_names', true);
    }
