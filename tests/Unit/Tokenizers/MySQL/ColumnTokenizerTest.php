...
class ColumnTokenizerTest extends TestCase
{
    ...
    {
        config()->set('advanced-migration-generator.definitions.with_comments', false);
        $columnTokenizer = ColumnTokenizer::parse('`favorite_color` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT \'favorite color\'');
        $columnDefinition = $columnTokenizer->definition();
        ...
        config()->set('advanced-migration-generator.definitions.with_comments', true);
    }
    ...
    {
        config()->set('advanced-migration-generator.definitions.prefer_unsigned_prefix', false);
        ...
        config()->set('advanced-migration-generator.definitions.prefer_unsigned_prefix', true);
    }
