...
class IndexDefinition
{
    ...
    public function render(): string
    {
        if ($this->indexType === 'foreign') {
            $indexName = '';
            if (config('migration-generator.definitions.use_defined_foreign_key_index_names')) {
            ...
            $indexName = '';
            if (config('migration-generator.definitions.use_defined_primary_key_index_names') && $this->getIndexName() !== null) {
                $indexName = ', \'' . $this->getIndexName() . '\'';
            }
            ...
            $indexName = '';
            if (config('migration-generator.definitions.use_defined_unique_key_index_names')) {
                $indexName = ', \'' . $this->getIndexName() . '\'';
            }
            ...
            $indexName = '';
            if (config('migration-generator.definitions.use_defined_index_names')) {
                $indexName = ', \'' . $this->getIndexName() . '\'';
            }
