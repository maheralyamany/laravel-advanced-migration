...
use App\Helpers\ValueToString;
use App\Helpers\WritableTrait;
...
class ColumnDefinition
{
    ...
    protected function guessLaravelMethod()
    {
        ...
        if (config('migration-generator.definitions.prefer_unsigned_prefix') && $this->unsigned) {
    ...
    public function render(): string
    {
        ...
        if ($this->index) {
            $indexName = '';
            if (count($this->indexDefinitions) === 1 && config('migration-generator.definitions.use_defined_index_names')) {
        ...
        if ($this->primary && !$this->isPrimaryKeyMethod($finalMethodName)) {
            $indexName = '';
            if (count($this->indexDefinitions) === 1 && config('migration-generator.definitions.use_defined_primary_key_index_names')) {
