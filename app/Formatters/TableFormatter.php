...
class TableFormatter
{
    ...
    public function getStubPath(): string
    {
        ...
        if (file_exists($overridden = resource_path('stubs/vendor/migration-generator/' . $driver . '-table.stub'))) {
            return $overridden;
        }

        if (file_exists($overridden = resource_path('stubs/vendor/migration-generator/table.stub'))) {
            return $overridden;
        }
    ...
    public function getStubCreatePath(): string
    {
        ...
        if (file_exists($overridden = resource_path('stubs/vendor/migration-generator/' . $driver . '-table-create.stub'))) {
            return $overridden;
        }

        if (file_exists($overridden = resource_path('stubs/vendor/migration-generator/table-create.stub'))) {
            return $overridden;
        }
    ...
    public function getStubModifyPath(): string
    {
        ...
        if (file_exists($overridden = resource_path('stubs/vendor/migration-generator/' . $driver . '-table-modify.stub'))) {
            return $overridden;
        }

        if (file_exists($overridden = resource_path('stubs/vendor/migration-generator/table-modify.stub'))) {
            return $overridden;
        }
    ...
    public function stubNameVariables($index): array
    {
        ...
        return [
            ...
            'IndexedTimestamp' => app('migration-generator:time')->clone()->addSeconds($index)->format('mdHis'),
            /* 'IndexedTimestamp' => app('migration-generator:time')->clone()->addSeconds($index)->format('Y_m_d_His'), */
        ];
    }
